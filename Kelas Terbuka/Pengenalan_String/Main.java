...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("komponen pertama dari String = " + kataString.charAt(2));

        // merubah komponen dar String
        ...
        // 3. membuat string dengan method, baru maka dia akan diatro di memory lain bukan di string pool
