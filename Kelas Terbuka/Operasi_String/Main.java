...
public class Main {
    public static void main(String[] args) {
        ...
        // Compare
        String motor1 = "royal endield himalayan";
        String motor2 = "kawasaki w175";
        System.out.println(motor1.compareTo(motor2)); // klmopqr
        ...
        // String kataInput = new String("test"); // ini buka string literal, dan tidak berada di string pool
        ...
        kataInput = userInput.next(); // tidakdi string pool
