...
public class AggregateOperationTest {
    ...
    @Test
    void testMax() {
        List.of("Eko", "Kurniwan", "Khannedy", "Programmer", "Zaman", "Now").stream()
    ...
    @Test
    void testCount() {
        long count = List.of("Eko", "Kurniwan", "Khannedy", "Programmer", "Zaman", "Now").stream()
                .count();
    ...
    @Test
    void testSum() {
        var reuslt = List.of(1, 2, 3, 4, 5).stream()
